  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <div
          className={`${empresa.cor} w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-base shadow-sm flex-shrink-0`}
        >
          {empresa.inicial}
        </div>
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-gray-900 text-base group-hover:text-primary transition-colors truncate">
            {empresa.nome}
          </h3>
        ...
        <button
          ...
          title={
            linked
              ? 'Calendário vinculado ao Google Calendar'
