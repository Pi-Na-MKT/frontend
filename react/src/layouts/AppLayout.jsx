...
export default function AppLayout({ children, activePage, onNavigate, searchPlaceholder = 'Buscar...' }) {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] flex">
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full z-40 flex flex-col bg-white border-r border-gray-100 w-56
      ...
      >
        ...
        <div className="flex items-center gap-2 px-5 py-5 border-b border-gray-100">
          ...
          <span className="text-xs text-gray-400 font-medium hidden xl:block">Marketing</span>
        </div>
        ...
        <div className="p-3 border-t border-gray-100">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-2 w-full px-3 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 transition-all mt-1"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-100 px-4 lg:px-6 py-3 flex items-center gap-4 sticky top-0 z-20 shadow-sm">
          ...
          <div className="ml-auto flex items-center gap-3">
            {/* Notificações */}
            <button className="relative p-2 text-gray-500 hover:text-gray-700 transition-colors rounded-xl hover:bg-gray-50">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="avatar"
                />
                <span className="hidden sm:block text-sm font-medium text-gray-700 pr-1">{user?.nome?.split(' ')[0]}</span>
      ...
      {/* Help button */}
      <button className="fixed bottom-6 right-6 w-10 h-10 bg-gray-800 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg hover:bg-gray-700 transition-colors z-50">
        ?
      </button>
    </div>
  )
